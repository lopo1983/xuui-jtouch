...
(function(){
  $.jQT=(function(){
    ...
    jQT.prototype.animations=[
      {name:"cubeleft",selector:".cubeleft,.cube"},
      {name:"cuberight",selector:".cuberight"},
      {name:"dissolve",selector:".dissolve"},
      {name:"flipleft",selector:".flipleft,.flip"},
      {name:"flipright",selector:".flipright"},
      {name:"pop",selector:".pop"},
      {name:"swapleft",selector:".swapleft,.swap"},
      {name:"swapright",selector:".swapright"},
